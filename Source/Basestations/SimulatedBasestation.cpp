...
bool SimulatedBasestation::open()
{
	...
	headstages.add(new SimulatedHeadstage(this, 0, "PRB_1_4_0480_1", 99998));
	headstages.add(new SimulatedHeadstage(this, 0, "PRB_1_4_0480_1", 99997));
	headstages.add(new SimulatedHeadstage(this, 0, "PRB_1_4_0480_1", 99996));
